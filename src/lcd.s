...
db1
	...
	bx lr
;----------------------------------------------------------------------------
showpalettename_		;palettename output, r0-r3=used.
;----------------------------------------------------------------------------

	ldrb r0,palettenameshow
	tst r0,#0xff
	bxeq lr					;End if not enabled

	sub r0,r0,#1
	strb r0,palettenameshow
...
pn2
	...
	ldr r1,=paltxt ;get palette name
	ldr r2,palettebank
	add r1,r1,r2,lsl#2
	ldr r1,[r1]
