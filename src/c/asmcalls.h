...
void reboot(); //needs to be written!

extern void *ewram_textstart; //needs to be filled!
extern u32 max_multiboot_size; //needs to be filled!

//gbz80.s
void update_doublespeed(void);
