...
DMA3BUFF		EQU BG0CNTBUFF-164*4
SCROLLBUFF1		EQU DMA3BUFF-160*8
SCROLLBUFF2		EQU SCROLLBUFF1-160*8
DMA0BUFF		EQU SCROLLBUFF2-160*8
END_OF_EXRAM	EQU DMA0BUFF-0x2000	;How much data is left for Multiboot to work.
