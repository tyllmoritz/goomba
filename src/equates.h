...
Next SETA MEM_END
	...
	[ MOVIEPLAYER
FAT_MEM_END EQU MEM_END
FAT_MEM_START EQU FAT_MEM_END-4096
fatBuffer	EQU FAT_MEM_END-512
fatWriteBuffer EQU fatBuffer
globalBuffer    EQU fatBuffer-512
lfnName			EQU globalBuffer-256
SramName		EQU lfnName-256
openFiles       EQU SramName-1200
stateexist	EQU openFiles-36
System	EQU stateexist-4
PALMode EQU System-4
rom_file EQU PALMode-4
nocash	EQU rom_file-4
rom_filesize EQU nocash-4

Next SETA FAT_MEM_START
	]

	[ RESIZABLE
	|
XGB_SRAM	EQU Next-0x8000
...
SGB_PACKET	EQU SGB_ATFS-112
SGB_ATTRIBUTES EQU SGB_PACKET-360

Next	SETA SGB_ATTRIBUTES
	]




GBOAMBUFF1	EQU Next-160
...
Next	SETA SPEEDHACK_FIND_JR_NC_BUF
	]
MULTIBOOT_LIMIT	EQU Next	;How much data is left for Multiboot to work.
END_OF_EXRAM EQU MULTIBOOT_LIMIT
