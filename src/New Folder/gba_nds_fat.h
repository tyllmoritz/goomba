...
#define disc_Init() MPCF_StartUp()

#define disc_IsInserted()	MPCF_IsInserted()
#define disc_ClearStatus()	MPCF_ClearStatus()

#define disc_ReadSectors(sector,count,buffer)	MPCF_ReadSectors(sector,count,buffer)
#define disc_WriteSectors(sector,count,buffer)	MPCF_WriteSectors(sector,count,buffer)
