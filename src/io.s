...
io_read_tbl
	...
	DCD void
	DCD void	;KEY1 - bit 7, Read current speed of CPU - CGB Mode Only
	DCD void
	...
	DCD void
	DCD void
	DCD void	;BCPS - BG Color Palette Specification
	DCD void	;BCPD - BG Color Palette Data
	DCD void	;OCPS - OBJ Color Palette Specification
	DCD void	;OCPD - OBJ Color Palette Data
	DCD void
	DCD void
	DCD void
	DCD void

	DCD void	;SVBK - WRAM Bank - CGB Mode Only
	DCD void
	DCD void
	DCD void
	DCD void
...
joypad_write_ptr
	...
	DCD void	;LY - LCD Y-Coordinate(R)
	...
	DCD void
	DCD void	;KEY1 - Prepare Speed Switch - CGB Mode Only
	DCD void
	DCD void	;VBK - VRAM Bank - CGB Mode Only
...
;	and r0,r0,#0xff		;not needed?
	and r1,r0,#0xE0
	adr r2,memmap_tbl
	ldr r1,[r2,r1,lsr#3]	;in: addy,r1=addy&0xE000 (for rom_R)
...
sendreset       ;exits with r1=emuflags, r4=REG_SIOCNT, Z=1 if send was OK
	...
	add r5,r5,#0x100
        ...
        ldr r1,emuflags
	and r0,r1,#USEPPUHACK+NOCPUHACK
